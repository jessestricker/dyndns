...
class DynDnsClient(
    ...
    suspend fun update(
        ...
        val outdatedRecords = records.filter { record ->
            when (record) {
        ...
        dnsClient.updateRecords(
            zone,
            toDelete = outdatedRecords,
            toCreate = missingRecords,
        )
    }
}
